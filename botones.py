...
class Boton():
      ...
      def collision(self):
            # ---- Obteniendo posicion del mouse para verificar colision ----
...
boton_InvHorizontal = Boton((830, yblit+75*4), botonInvhorizontal, 0.1)
boton_InvVertical = Boton((890, yblit+75*4), botonInvvertical, 0.1)
...
listaBotonesAcciones=[boton_Regreso, boton_RotarDer, boton_RotarIz, boton_ZoomIn, boton_ZoomOut, boton_Guardar, boton_Cargar,
      boton_Borrar, boton_Limpiar, boton_InvHorizontal, boton_InvVertical, boton_AltoContraste, boton_Negativo]